...
if(!class_exists('cpb_hover_background')):
   class cpb_hover_background{
      public function render_form(){
         return array(
           'type'          => 'cpb_hover_background',
      ...
      public function load_shortcode(){
         add_shortcode( 'hover_background', array('cpb_hover_background', 'sc_hover_background'));
      }
   }
endif;   
