...
if(!class_exists('cpb_accordion')):
   class cpb_accordion{
      ...
      public function load_shortcode(){
         add_shortcode( 'accordion', array('cpb_accordion', 'sc_accordion'));
         add_shortcode( 'accordion_item', array('cpb_accordion', 'sc_accordion_item') );
      }
